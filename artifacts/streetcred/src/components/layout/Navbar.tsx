    ...
    <nav className="sticky top-0 z-50 w-full bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/80 border-b border-white/10">
      <div className="container mx-auto px-4 h-20 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-3 group">
          ...
          />
          <span className="font-display text-3xl tracking-widest uppercase hidden sm:inline-block group-hover:text-primary transition-colors">Streetcred</span>
        </Link>
        ...
        <div className="flex items-center gap-4">
          <Link href="/shop" className="p-2 hover:text-primary transition-colors">
