      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-sm font-sans mb-4 leading-relaxed">
              StreetCred is a bold, urban brand and podcast that embodies the spirit of authenticity and
              street smarts. 🌆
            </p>
          ...
          <div>
            <h4 className="font-display text-2xl tracking-wider mb-6">Links</h4>
            <ul className="flex flex-col gap-3 text-muted-foreground font-sans">
              <li>
                <a href="#podcast" className="hover:text-primary transition-colors">
                  The Podcast
                </a>
              </li>
              <li>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-muted-foreground">
          ...
          <p>
            Website designed by{" "}
            <a
              href="https://frankkaumba.gamer.gd"
              target="_blank"
              rel="noreferrer"
              className="text-white hover:text-primary underline decoration-primary/50 underline-offset-4 transition-colors"
            >
              Frankkaumbadev
            </a>
          </p>
